     ...
     <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium at minus repudiandae quia aliquid deleniti aliquam reiciendis veniam. Hic est ipsum repudiandae modi illo cumque blanditiis ipsa quisquam accusamus aperiam!</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure vel inventore fugit commodi doloremque omnis impedit quaerat officiis libero eveniet perspiciatis consequatur voluptates quos enim repudiandae, quo deleniti aut provident?</p>
        </div>
