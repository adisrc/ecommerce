...
const Terms = () => {
  return (
    ...
    <p>Last updated on 23-12-2024 16:37:19</p>
    <p>
        These Terms and Conditions, along with the Privacy Policy or other terms ("Terms") constitute a binding agreement
        by and between ADITYA PRAKASH ("Website Owner" or "we" or "us" or "our") and you ("you" or "your") and relate
        to your use of our website, goods (as applicable), or services (as applicable) (collectively, "Services").
    </p>
    <p>
        By using our website and availing the Services, you agree that you have read and accepted these Terms (including
        the Privacy Policy). We reserve the right to modify these Terms at any time and without assigning any reason. It
        is your responsibility to periodically review these Terms to stay informed of updates.
    </p>
    ...
    <ol>
        ...
        <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Sonenagar, Bihar.</li>
